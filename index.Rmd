...
output:
  html_document:
    toc: false  # Disable default TOC since we'll create our own
    theme: readable
    highlight: pygments
...
cat('<div class="custom-toc">
<h4>Contents</h4>
<ul>
  <li><a href="#load-packages">1. Load packages</a></li>
  <li><a href="#demographic-data">2. Demographic data</a></li>
  <li><a href="#the-demokin-package">3. The DemoKin package</a></li>
  <li><a href="#kinship-diagrams">4. Kinship diagrams</a></li>
  <li><a href="#number-of-living-kin">5. Number of living kin</a></li>
  <li><a href="#age-distribution-of-living-kin">6. Age distribution of living kin</a></li>
</ul>
</div>')
```
...
#### 2. Demographic data {#demographic-data}
...
#### 3. The DemoKin package {#the-demokin-package}
...
#### 4. Kinship diagrams {#kinship-diagrams}
...
#### 5. Number of living kin {#number-of-living-kin}
...
#### 6. Age distribution of living kin {#age-distribution-of-living-kin}
...
<h4>Contents</h4>
<ul>
  <li><a href="#run-the-model-time-varying">1. Run the model</a></li>
  <li><a href="#living-relatives">2. Living Relatives</a></li>
  <li><a href="#kin-loss">3. Kin Loss</a></li>
  <li><a href="#prevelances">4. Prevelances</a></li>
</ul>
</div>')
```
...
#### 1. Run the model {#run-the-model-time-varying}
...
#### 2. Living Realtives {#living-relatives}
...
<h4>Contents</h4>
<ul>
  <li><a href="#model-input-2sex">1. Model Input</a></li>
  <li><a href="#run-model-2sex">2. Run the model</a></li>
</ul>
</div>')
```
...
#### 1. Model input {#model-input-2sex}
...
#### 2. Run the model {#run-model-2sex}
...
<h4>Contents</h4>
<ul>
  <li><a href="#model-input-2sex-time-varying">1. Model input</a></li>
  <li><a href="#run-mode-2sex-time-varying">2. Run the model</a></li>
  <li><a href="#kin-availability-2sex-time-varying">3. Kin Availability</a></li>
  <li><a href="#approximations">4. Approximations</a></li>
  <li><a href="#prevelance-2sex-time-varying">5. Prevelance again: Causes of death</a></li>
</ul>
</div>')
```
We look at populations where demographic rates are not static but change on a yearly basis. 

#### 1. Model input {#model-input-2sex-time-varying}
...
#### 2. Run the model {#run-model-2sex-time-varying}
...
#### 3. Kin Availability {#kin-availability-2sex-time-varying}
...
#### 4. Approximations {#approximations}
...
#### 5. Prevelance again: Causes of death {#prevalance-2sex-time-varying}
...
<h4>Contents</h4>
<ul>
  <li><a href="#run-model-multi-state">1. Run the model</a></li>
  <li><a href="#age-and-parity-distribution">2. Age and parity distribution of kin</a></li>
    <li><a href="#kin-by-parity">3. Kin counts by parity</a></li>
...
#### 1. Run the model {#run-model-multi-state}
...
#### 2. Age and parity distribution of kin {#age-and-parity-distribution}
...
#### 3. Kin counts by parity {#kin-by-parity}
...
<h4>Contents</h4>
<ul>
  <li><a href="#parity-as-stage">1. Parity as the stage</a></li>
  <li><a href="#education-as-stage">2. Education as the stage</a></li>
</ul>
</div>')
```
...
#### Parity as the stage {#parity-as-stage}
...
#### Education as the stage {#education-as-stage}
